package com.example.irsis.Lbs.android_path_record;
...
import com.example.irsis.Lbs.database.DbAdapter;
import com.example.irsis.Lbs.record.PathRecord;
import com.example.irsis.Lbs.recordutil.Util;
import com.example.irsis.R;

public class TrackActivity extends CheckPermissionsActivity implements LocationSource,
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (btn.isChecked()) {
                    ...
                    mTraceClient.queryProcessedTrace(2, Util.parseTraceLocationList(record.getPathline()) , LBSTraceClient.TYPE_AMAP, TrackActivity.this);
    ...
    protected void saveRecord(List<AMapLocation> list, String time) {
        if (list != null && list.size() > 0) {
            ...
            Toast.makeText(TrackActivity.this, "没有记录到路径", Toast.LENGTH_SHORT)
                    .show();
        }
    }
...
//		}
    ...
    public void record(View view) {
        Intent intent = new Intent(TrackActivity.this, RecordActivity.class);
        ...
        if (lineID == 1) {
            if (linepoints != null && linepoints.size()>0) {
                ...
                if (mlocMarker == null) {
                    ...
                    Toast.makeText(TrackActivity.this, "距离"+mDistance, Toast.LENGTH_SHORT).show();
